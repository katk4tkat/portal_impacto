...
function CreateActivityForm() {
  ...
  const [techUnitSelectedOption, setTechUnitSelectedOption] = useState("");
  ...
  const onSubmit = async (formData) => {
    try {
      ...
      const newActivity = {
        ...
        n_aviso: "",
        u_tecnica: techUnitSelectedOption.value,
        ...
        <div className="col-md-7">
          <div className="card">
            <div className="card-body">
              ...
              <div className="form-group">
                <label htmlFor="description">Descripción del Estado:</label>
                <Controller
                  name="description"
                  control={control}
                  defaultValue=""
