...
import {
  createActivityPlanningDocument,
...
function ActivityPlanningForm({ documentId }) {
  ...
  const [
    detailedActivitydescriptionInput,
    setDetailedActivitydescriptionInput,
  ] = useState("");
  ...
  const onSubmit = async (formData) => {
    try {
      ...
      setIsLoading(false);
      toast.success("Actividad planificada exitosamente.");
      reset({
        OT: "",
        program_start: "",
        real_program_start: "",
        ...
        <div className="col-md-7">
          <div className="card">
            <div className="card-body">
              ...
              <div className="form-group">
                <label htmlFor="detailed_activity_description">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <textarea
                      ...
                      required
                      value={detailedActivitydescriptionInput}
                      onChange={(e) => {
              ...
              <div className="form-group">
                <label htmlFor="relevant_technical_specifications">
              ...
              <div className="form-group">
                <label htmlFor="general_step_by_step">
                  Paso a paso general:
                </label>
                <Controller
              ...
              <div className="form-group">
                <label htmlFor="required_material">
              ...
              <div className="form-group">
                <label htmlFor="required_support_equipment">
              ...
              <div className="form-group">
                <label htmlFor="risks_and_controls">
                  Riesgos críticos y controles aplicados:
                </label>
                <Controller
              ...
              <div className="form-group">
                <label htmlFor="risk_analysis">
                  Análisis de riesgos (¿Qué pasa sí?):
                </label>
                <Controller
                  name="risk_analysis"
                  control={control}
